...
export interface DfreelancerInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "getAllFreelancers",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Dfreelancer extends BaseContract {
  ...
  allJobs: TypedContractMethod<[], [Djob.JobStructOutput[]], "view">;
  ...
  getAllFreelancers: TypedContractMethod<
    [],
    [Djob.FreelancerStructOutput[]],
    "view"
  >;
  ...
  ): TypedContractMethod<[], [Djob.JobStructOutput[]], "view">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "getAllFreelancers"
  ): TypedContractMethod<[], [Djob.FreelancerStructOutput[]], "view">;
  getFunction(
